...
public class QueryCertificateServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QueryCertificateServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			certificate = cs.findCertificateByTeacherId(teacherid);
		...
		RequestDispatcher rd = request.getRequestDispatcher("certificateDetail.jsp");
