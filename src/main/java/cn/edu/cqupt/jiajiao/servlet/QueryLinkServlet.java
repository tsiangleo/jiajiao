...
public class QueryLinkServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QueryLinkServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(	linkList != Collections.EMPTY_LIST)	//news不为空
		{
			request.setAttribute("linkList", linkList);
			RequestDispatcher rd = request.getRequestDispatcher("linkList.jsp");
