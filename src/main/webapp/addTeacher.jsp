...
if (teacherform.year.value=='' || teacherform.month.value=='' || teacherform.day.value=='' ) { alert('请选择出生日期!');  return false; }
      ...
      <form name="teacherform" method="post" action="addTeacher.do" enctype="multipart/form-data"  onsubmit="return teacherformcheck()" ><table align="center" bgcolor="#FFFFFF" width="1000" border="0" cellpadding="0" cellspacing="0" style="border:1px #BCDFFF solid;">
            <tbody><tr>
              <td height="30" colspan="4" align="left" background="images/sort_top.jpg"><table width="960" border="0" cellpadding="0" cellspacing="0">
                  <tbody><tr><td width="120" align="left" style="font-size:15px;color:#FF6600;font-weight:bold;">　填写家教信息</td>
            ...
            <tr height="30"></tr>
 			...
 			<tr>
             	...
             	<td height="40" colspan="2" align="left" style="font-size:18px;line-height:160%;">
             		 <font color="#FF0000"> 
	                <%
						String addteachertMsg = (String)request.getAttribute("addteachertMsg");
						if(addteachertMsg != null)
							out.println(addteachertMsg);
	 				%>        		
	 				</font>
             	</td>
                <td height="40" align="left" style="font-size:12px;line-height:160%;"></td>
           ...
           <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>真实姓名：              </td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="teachername" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjchenghu);" onblur="javascript:onblur_check(jjchenghu);" id="teachername"></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;"><font color="#FF0000"></font></td>
            </tr>
            
            <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>移动电话：              </td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="mobilephone" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="mobilephone"></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;"><font color="#FF0000">（请填写您的有效联系电话，便于家长预约您！）</font></td>
            </tr>
            
             <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>学　　历：
                </td>
            ...
            <tr>
              ...
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input name="gender" type="radio" checked="checked" value="男">男　<input type="radio" name="gender" value="女">女</td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">&nbsp;</td>
            </tr>
            
             <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>所在学校：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;">
            	 <select name="school" id="zztop1_ddlyuanxiao" style="width:100px;">
            ...
            <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000"> </font> 专　　业：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="specialty" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="specialty" /></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;"><font color="#FF0000">如：计算机科学与技术</font></td>
            </tr>
            
               <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">&nbsp;  </font> 住　　址：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="address" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="address" /></td>                  
              <td height="40" align="left" style="font-size:12px;line-height:160%;">&nbsp;</td>
            </tr>
             ...
             <tr>
              ...
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>辅导年级：</td>
              ...
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>辅导科目：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><select name="subject" id="zztop1_ddlfdkm" style="width:100px;">
              ...
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>授课区域：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><select name="servicearea" id="zztop1_ddlfdplace" style="width:100px;">
				<option value="不限">不限</option>
              ...
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font>辅导方式：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><select name="servicetype" id="servicetype" onchange="javascript:sort_list(this.value);">
              ...
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">*</font> 薪水要求：</td>
             ...
             <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">&nbsp; </font> 个人照片：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="file" name="photo" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="certificate" /></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;"><font color="#FF0000">最好是一寸免冠近照</font></td>
             </tr>
            
              <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">&nbsp; </font> 所获证书：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="certificate" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="certificate" /></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;"><font color="#FF0000">如：英语六级证书</font></td>
            </tr>
            
               <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">&nbsp; </font>自我描述：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="description" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="description" /></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">&nbsp;</td>
            </tr>
            
               <tr>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">　　　　　　　　　　　　　　　　　<font color="#FF0000">&nbsp; </font>补充信息：</td>
              <td height="40" colspan="2" align="left" style="font-size:12px;line-height:160%;"><input type="text" name="notes" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="notes" /></td>
              <td height="40" align="left" style="font-size:12px;line-height:160%;">&nbsp;</td>
            </tr>
            ...
            <tr>
              <td height="40" colspan="4" align="center" style="font-size:12px;line-height:160%;"><input name="imageField" type="image" src="./images/tijiao.png" width="80" height="30" border="0"/></td>
            </tr>			
			</tbody></table>
        </form>  
