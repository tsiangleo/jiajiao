...
<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
	<form name="teacherform" method="post" onsubmit="return teacherformcheck()"  action="updateTeacher.do?flag=1" enctype="multipart/form-data">
    	<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
    	<div class="content_list">
               ...
               <table cellpadding="1" cellspacing="1"  border="0"class="mberTab">
                       ...
                       <tbody>
                         <tr>
                           <th  colspan="4"><table width="690" border="0" cellpadding="0" cellspacing="0">
                             <tbody>
                               <tr>
                                 <td width="120" align="left">更新信息</td>
                         ...
                         <tr>
                           ...
                           <td width="50%" class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" value="<%=teacherinfo.getTeachername() %>"  readonly="readonly" name="teachername" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjchenghu);" onblur="javascript:onblur_check(jjchenghu);" id="teachername" />
                           </span></td>
                         </tr>
                         <tr>
                           <td width="50%" align="right"><span style="font-size:12px;line-height:160%;"><font color="#FF0000">*</font>移动电话：</span></td>
                           <td width="50%" class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" name="mobilephone" value="<%=teacherinfo.getMobilephone() %>" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="mobilephone" />
                           </span></td>
                         </tr>
                         <tr>
                           ...
                           <td width="50%" class="green"><span style="font-size:12px;line-height:160%;">
                             <select  value="<%=teacherinfo.getDegree() %>" name="degree" id="degree" onchange="javascript:sort_list(this.value);">
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input value="<%=teacherinfo.getGender() %>" name="gender" type="radio" checked="checked"  />
                             男　
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="school" value="<%=teacherinfo.getSchool() %>" id="school" style="width:100px;">
                ...
                <option value="重庆交通职业学院">重庆交通职业学院</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" value="<%=teacherinfo.getSpecialty() %>" name="specialty" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="specialty" />
                           </span></td>
                         </tr>
                         <tr>
                           <td align="right"><span style="font-size:12px;line-height:160%;">住　　址：</span></td>
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" value="<%=teacherinfo.getAddress() %>" name="address" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="address" />
                           </span></td>
                         </tr>
              ...
              <td>  
              <select id="year" value="<%=teacherinfo.getBirthday().substring(0, 4) %>" onchange="changeday()" name="year"> <option value="">年</option> </select>  
              <select id="month" value="<%=teacherinfo.getBirthday().substring(5, 7) %>" name="month"  onchange="changeday()"><option value="">月</option> </select>
              <select id="day" value="<%=teacherinfo.getBirthday().substring(8, 10) %>" name="day" ><option value="">日</option> </select>     
              ...
              <td height="40" align="left" style="font-size:12px;line-height:160%;">&nbsp;</td>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select value="<%=teacherinfo.getGrade() %>" name="grade" id="grade" style="width:100px;">
                ...
                <option value="退休老人">退休老人</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="subject" value="<%=teacherinfo.getSubject() %>" id="subject" style="width:100px;">
                ...
                <option value="其他">其他</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="servicearea" value="<%=teacherinfo.getServicearea() %>" id="servicearea" style="width:100px;">
                               <option value="不限">不限</option>
                ...
                <option value="彭水">彭水</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="servicetype" value="<%=teacherinfo.getServicetype() %>" id="servicetype" onchange="javascript:sort_list(this.value);">
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="salary" value="
                              ...
                              %>" id="salary" onchange="javascript:sort_list(this.value);">
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" name="certificate" value="<%=teacherinfo.getCertificate() %>" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="certificate" />
                           </span></td>
                         </tr>
                         <tr>
                           <td align="right"><span style="font-size:12px;line-height:160%;">自我描述：</span></td>
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" name="description" value="<%=teacherinfo.getDescription() %>" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="description" />
                           </span></td>
                         </tr>
                         <tr>
                           <td align="right"><span style="font-size:12px;line-height:160%;"><font color="#FF0000">&nbsp; </font>补充信息：</span></td>
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" name="notes" value="<%=teacherinfo.getNotes() %>" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(jjrealname);" onblur="javascript:onblur_check(jjrealname);" id="notes" />
                           </span></td>
                         </tr>
