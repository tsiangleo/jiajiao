...
<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
	<form name="user_form" method="post" onsubmit="return user_formcheck()" action="updateStudent.do?id=<%=studentinfo.getId() %>" >
    	<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
                       ...
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input name="studentname" value="<%=studentinfo.getStudentname() %>" type="text" id="studentname" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(mobile);" onblur="javascript:onblur_check(mobile);" />
                           </span></td>
                         </tr>
                         <tr>
...
女</span></td>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="grade" id="grade" style="width:100px;">
                              <option  <%=(studentinfo.getGrade().equals("幼儿教育")?"selected":"")%> value="幼儿教育">幼儿教育</option>
                <option <%=(studentinfo.getGrade().equals("小学一年级")?"selected":"")%> value="小学一年级">小学一年级</option>
                <option <%=(studentinfo.getGrade().equals("小学二年级")?"selected":"")%> value="小学二年级">小学二年级</option>
                <option <%=(studentinfo.getGrade().equals("小学三年级")?"selected":"")%> value="小学三年级">小学三年级</option>
                <option <%=(studentinfo.getGrade().equals("小学四年级")?"selected":"")%> value="小学四年级">小学四年级</option>
                <option <%=(studentinfo.getGrade().equals("小学五年级")?"selected":"")%> value="小学五年级">小学五年级</option>
                <option <%=(studentinfo.getGrade().equals("小学六年级")?"selected":"")%> value="小学六年级">小学六年级</option>
                <option <%=(studentinfo.getGrade().equals("初中一年级")?"selected":"")%> value="初中一年级">初中一年级</option>
                <option <%=(studentinfo.getGrade().equals("初中二年级")?"selected":"")%> value="初中二年级">初中二年级</option>
                <option <%=(studentinfo.getGrade().equals("初中三年级")?"selected":"")%> value="初中三年级">初中三年级</option>
                <option <%=(studentinfo.getGrade().equals("高中一年级")?"selected":"")%> value="高中一年级">高中一年级</option>
                <option <%=(studentinfo.getGrade().equals("高中二年级")?"selected":"")%> value="高中二年级">高中二年级</option>
                <option <%=(studentinfo.getGrade().equals("高中三年级")?"selected":"")%> value="高中三年级">高中三年级</option>
                <option <%=(studentinfo.getGrade().equals("大学一年级")?"selected":"")%> value="大学一年级">大学一年级</option>
                <option <%=(studentinfo.getGrade().equals("大学二年级")?"selected":"")%> value="大学二年级">大学二年级</option>
                <option <%=(studentinfo.getGrade().equals("大学三年级")?"selected":"")%> value="大学三年级">大学三年级</option>
                <option <%=(studentinfo.getGrade().equals("大学四年级")?"selected":"")%> value="大学四年级">大学四年级</option>
                <option <%=(studentinfo.getGrade().equals("在读研究生")?"selected":"")%> value="在读研究生">在读研究生</option>
                <option <%=(studentinfo.getGrade().equals("在职员工")?"selected":"")%> value="在职员工">在职员工</option>
                <option <%=(studentinfo.getGrade().equals("退休老人")?"selected":"")%> value="退休老人">退休老人</option>
                             </select>
                           </span></td>
                         </tr>
                         <tr>
                ...
                <option value="其他">其他</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input name="description" value="<%=studentinfo.getDescription() %>" type="text" id="description" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(mobile);" onblur="javascript:onblur_check(mobile);" />
                           </span></td>
                         </tr>
