...
<% Notice noticeinfo = (Notice)request.getAttribute("noticeinfo"); 
%>
...
<div class="bk left" id="mainContentbox">
            ...
            <div class="bknr">
                <div class="mainContent">
                    <div id="Position1_PositionDiv" class="position">当前位置：<a href="#">首页</a> > <a href="#">系统公告</a></div>       
                    <div class="cate_title">
                        <h1 id="VideoTitle"><%=noticeinfo.getTitle() %></h1>
                       <center>发布时间：<%=noticeinfo.getPublishtime() %>&nbsp;&nbsp;
                    	</center>
