...
<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    ...
    <div class="content_list">
       <br>
            <form name="user_form" method="post" action="updateMember.do?flag=2" >
            
               <table cellpadding="1" cellspacing="1"  border="0"class="mberTab">
                <tbody><tr>
                  <th  colspan="4"><strong>邮箱设置</strong></th>
                </tr>
           
                 <tr>
	              <td height="40" width="50%" align="right" style="font-size:12px;line-height:160%;">您的邮箱：</td>
	              <td height="40" width="50%"colspan="2" align="left" style="font-size:12px;line-height:160%;">
	              	<input type="text" value="<%=memberInfo.getEmail() %>" name="email" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;">
	              </td>
	           </tr>
