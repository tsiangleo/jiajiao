...
<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
	<form name="user_form" method="post" onsubmit="return user_formcheck()"  action="updateRequirement.do?flag=1&&id=<%=requirementinfo.getId() %>" >
    	<table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td>
               ...
               <table cellpadding="1" cellspacing="1"  border="0"class="mberTab">
                     ...
                     <td class="green"><table cellpadding="1" cellspacing="1"  border="0"class="mberTab">
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td width="50%" class="green"><span style="font-size:12px;line-height:160%;">
                             <input type="text" value="<%=requirementinfo.getPhone() %>"   name="phone" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(username);" onblur="javascript:onblur_check(username);" id="phone" />
                           </span></td>
                         </tr>
                         <tr>
                ...
                <option value="重庆交通职业学院">重庆交通职业学院</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input name="classtime" value="<%=requirementinfo.getClasstime() %>"  type="text" id="classtime" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(yourname);" onblur="javascript:onblur_check(yourname);" />
                           </span></td>
                         </tr>
                         
                          <tr>
                           <td align="right"><span style="font-size:12px;line-height:160%;"><font color="#FF0000">*</font> 需求状态：</span></td>
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <select name="state" id="state" onchange="javascript:sort_list(this.value);">
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input name="studentname" value="<%=requirementinfo.getStudentname() %>" type="text" id="studentname" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(mobile);" onblur="javascript:onblur_check(mobile);" />
                           </span></td>
                         </tr>
                         <tr>
...
女</span></td>
                ...
                <option value="其他">其他</option>
                         ...
                         <tr>
                           ...
                           <td class="green"><span style="font-size:12px;line-height:160%;">
                             <input name="description" value="<%=requirementinfo.getDescription() %>" type="text" id="description" style="width:200px;height:20px;line-height:20px;border:1px #6CB5FF solid;" onfocus="javascript:onfocus_check(mobile);" onblur="javascript:onblur_check(mobile);" />
                           </span></td>
                         </tr>
